...
def parse_input_no_conversion(input_file, custom_delimiter, input_columns, output_column, is_test):
    ''' This function parses the input data file, performing no conversion on the input values.
...
def parse_input(input_file, custom_delimiter, input_columns, output_column, is_test, input_literal_columns, input_label_mapping, output_literal, output_label_mapping):
    ''' This function parses the input data file and converts literal values using the specified mappings.
...
def readInputData(input_file, input_test_file, convert_literals, custom_delimiter, proportion_factor, split, input_columns, output_column, input_literal_columns, input_label_mapping, output_literal, output_label_mapping):
    ...
    Args:
        ...
        convert_literals: If True, the literals in the input files will be converted to numeric values as per the given mappings.
        custom_delimiter: The delimiter used in the input files.
    ...
    if convert_literals:
        ...
        (X, y) = parse_input_no_conversion(input_file, custom_delimiter, input_columns, output_column, False)
